...
<head>
    ...
    <title>FRI-035 Corporation - Production </title>
        ...
        <div class="row">
            ...
            ?>
                    <div class="alert alert-success" role="alert">
                        Product succesfully sent to warehouse.
                    </div>
            <?php }
            } ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Product Departure</h5>
                        <form action="process.php?action=departure" method="POST">
                            <div class="mb-3">
